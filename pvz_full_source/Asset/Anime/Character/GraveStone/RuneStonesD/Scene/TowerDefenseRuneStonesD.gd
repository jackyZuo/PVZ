...
const RUNE_STONESD_WATER_1 = preload("uid://ccon1sprvwel4")
const RUNE_STONESD_WATER_2 = preload("uid://c4ry20743py3d")
const RUNE_STONESD_WATER_3 = preload("uid://b0q0m465yqm8t")
const RUNE_STONESD_WATER_4 = preload("uid://dvoiq2vlsrfkc")
const RUNE_STONESD_WATER_5 = preload("uid://b0ohc1j25fydt")
...
func _ready() -> void :
    ...
    if is_instance_valid(cell) && cell.IsWater():
        ...
        sprite.SetReplace("RuneStones4_1.png", RUNE_STONESD_WATER_1)
    ...
    if is_instance_valid(cell) && cell.IsWater():
        match damangePointName:
            "Damage0":
                sprite.SetReplace("RuneStones4_1.png", RUNE_STONESD_WATER_1)
            "Damage1":
                sprite.SetReplace("RuneStones4_1.png", RUNE_STONESD_WATER_2)
            "Damage2":
                sprite.SetReplace("RuneStones4_1.png", RUNE_STONESD_WATER_3)
            "Damage3":
                sprite.SetReplace("RuneStones4_1.png", RUNE_STONESD_WATER_4)
            "Damage4":
                sprite.SetReplace("RuneStones4_1.png", RUNE_STONESD_WATER_5)
