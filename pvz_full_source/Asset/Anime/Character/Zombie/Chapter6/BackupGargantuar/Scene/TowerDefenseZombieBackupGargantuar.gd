...
const ZOMBIE_DISCO_GARGANTUAR_BODY_1 = preload("uid://btich27kmjtyn")
const ZOMBIE_DISCO_GARGANTUAR_BODY_1_2 = preload("uid://bl0pwounqyh8w")
const ZOMBIE_DISCO_GARGANTUAR_BODY_1_3 = preload("uid://cagioad3x3h3g")
...
func DamagePointReach(damangePointName: String):
    ...
    match damangePointName:
        "Arm":
            sprite.SetReplace("Zombie_DiscoGargantuar_body1.png", ZOMBIE_DISCO_GARGANTUAR_BODY_1_2)
        "Head":
            sprite.SetReplace("Zombie_DiscoGargantuar_body1.png", ZOMBIE_DISCO_GARGANTUAR_BODY_1_3)
