...
func Purify() -> void :
    ...
    if Global.isMultiplayerMode and !MultiPlayerManager.isHost:
        Destroy()
        return
    var packetConfig: TowerDefensePacketConfig = TowerDefenseManager.GetPacketConfig("PlantDoomTanglekelp")
    if cell.CanPacketPlant(packetConfig):
        ...
        if Global.isMultiplayerMode and MultiPlayerManager.isHost:
            ...
            if is_instance_valid(control):
                ...
                MultiPlayerManager.SendSpawnCharacterAt("PlantDoomTanglekelp", gridPos.x, gridPos.y, _sync_id)
    Destroy()
...
@warning_ignore("unused_parameter")
func Drag(_target: TowerDefenseCharacter, success: bool) -> void :
