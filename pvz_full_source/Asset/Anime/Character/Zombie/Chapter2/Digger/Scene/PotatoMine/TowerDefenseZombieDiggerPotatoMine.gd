...
func DigEntered() -> void :
    ...
    sprite.head.offset = Vector2(-58, -58)
    sprite.head.offsetRotate = 9.4
...
func DrillEntered() -> void :
    ...
    sprite.head.offset = Vector2(-58, -30)
    sprite.head.offsetRotate = 9.1
    ...
    if cell.CanPacketPlant(packetConfig, true):
        ...
        if Global.isMultiplayerMode and MultiPlayerManager.isHost:
            ...
            if is_instance_valid(control):
                ...
                MultiPlayerManager.SendSpawnCharacterAt("PlantPotatoMine", gridPos.x, gridPos.y, _sync_id)
    Destroy()
