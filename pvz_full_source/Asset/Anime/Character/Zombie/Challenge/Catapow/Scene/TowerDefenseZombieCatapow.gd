...
func _UpdateProjectileVisual() -> void :
    ...
    if current <= 0:
        sprite.SetFliters(["Zombie_catapult_basketball", "Zombie_catapult_basketball2", "Zombie_catapult_basketball3", "Zombie_catapult_basketball4", "Zombie_catapult_basketball5", "Zombie_catapult_basketball6", "cannon_ball"], false)
    elif current <= float(num) / 6 * 1:
        sprite.SetFliters(["Zombie_catapult_basketball5"], false)
    elif current < float(num) / 6 * 2:
        sprite.SetFliters(["Zombie_catapult_basketball4"], false)
    elif current < float(num) / 6 * 3:
        sprite.SetFliters(["Zombie_catapult_basketball3"], false)
    elif current < float(num) / 6 * 4:
        sprite.SetFliters(["Zombie_catapult_basketball2"], false)
    elif current < float(num) / 6 * 5:
