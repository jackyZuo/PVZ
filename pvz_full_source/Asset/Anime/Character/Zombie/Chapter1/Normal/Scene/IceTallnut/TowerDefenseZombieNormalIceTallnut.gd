...
const ICETALLNUT_BODY = preload("uid://rh7wmaf5jf1d")
const ICETALLNUT_CRACKED_1 = preload("uid://x5lfevvfwwq4")
const ICETALLNUT_CRACKED_2 = preload("uid://cj0bip3c2m8y8")
...
func DamagePointReach(damangePointName: String) -> void :
    ...
    match damangePointName:
        ...
        "Damage1":
            sprite.head.SetReplace("IceTallnut_body.png", ICETALLNUT_CRACKED_1)
        "Damage2":
            sprite.head.SetReplace("IceTallnut_body.png", ICETALLNUT_CRACKED_2)
...
func Purify() -> void :
    ...
    if Global.isMultiplayerMode and !MultiPlayerManager.isHost:
        Destroy()
        return
    var packetConfig: TowerDefensePacketConfig = TowerDefenseManager.GetPacketConfig("PlantIceTallnut")
    if cell.CanPacketPlant(packetConfig):
        ...
        if Global.isMultiplayerMode and MultiPlayerManager.isHost:
            ...
            if is_instance_valid(control):
                ...
                MultiPlayerManager.SendSpawnCharacterAt("PlantIceTallnut", gridPos.x, gridPos.y, _sync_id)
    Destroy()
