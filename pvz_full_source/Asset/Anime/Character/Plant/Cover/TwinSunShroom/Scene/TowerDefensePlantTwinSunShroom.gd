...
func Cover(character: TowerDefenseCharacter) -> void :
    if character.config.name == "PlantSunShroom":
        ...
        shadowComponent.saveShadowScale = character.shadowComponent.saveShadowScale
        shadowComponent.saveTransformPointScale = character.shadowComponent.saveTransformPointScale
