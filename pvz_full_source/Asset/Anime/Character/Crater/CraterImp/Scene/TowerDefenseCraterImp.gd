...
func DieDown() -> void :
    ...
    if Global.isMultiplayerMode and MultiPlayerManager.isHost:
        ...
        if is_instance_valid(control):
            ...
            MultiPlayerManager.SendSpawnCharacterAt("ZombieImpSkeleton", gridPos.x, gridPos.y, _sync_id, 1.0, 1.0, false, 0.0, true, global_position.x, global_position.y, true, groundHeight)
