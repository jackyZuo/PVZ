...
var inspector_tab_bar: InspectorTabBar
...
func _parse_end(object: Object) -> void :
    if current_parse_category != "Node": return
...
func _update_inspector() -> void :
    ...
    elif property_mode == TabPropertyModes.JUMP_SCROLL:
        var category_idx = -1
        var tab_idx = -1
