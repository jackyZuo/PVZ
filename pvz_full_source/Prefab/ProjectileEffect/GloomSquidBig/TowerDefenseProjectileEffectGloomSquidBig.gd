...
const GLOOM_SQUID_BIG_SPLATS_SCENE: PackedScene = preload("uid://cigw4jxihfp0r")
...
func AttackCreate() -> void :
    ...
    var effect: TowerDefenseEffectParticlesOnce = GLOOM_SQUID_BIG_SPLATS_SCENE.instantiate()
