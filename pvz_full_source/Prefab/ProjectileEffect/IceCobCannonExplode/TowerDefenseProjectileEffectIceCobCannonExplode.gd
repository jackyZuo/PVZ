...
const ICE_COB_CANNON_EXPLOSION = preload("uid://c0jqarake84mi")
...
func EffectCreate() -> void :
    ...
    var effect: TowerDefenseEffectParticlesOnce = TowerDefenseManager.CreateEffectParticlesOnce(ICE_COB_CANNON_EXPLOSION, gridPos)
